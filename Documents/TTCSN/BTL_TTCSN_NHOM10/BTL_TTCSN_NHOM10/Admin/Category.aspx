<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterpage.Master" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="BTL_TTCSN_NHOM10.Admin.Category" %>
                         ...
                         <div class="card-body">
                             ...
                             <div class="table-responsive">
                                 <asp:GridView ID="grdDs" runat="server" AutoGenerateColumns="false"
                                     ...
                                     <Columns>
                                         <asp:BoundField DataField="Category_id" HeaderText="Mã danh mục" runat="server">
                                             ...
                                             <ItemTemplate>
                                                 <div class="image-container">
                                                     <img src='<%# string.IsNullOrEmpty(Eval("Image")?.ToString()) ? ResolveUrl("~/Images/default.png") : ResolveUrl("~/Images/" + Eval("Image").ToString()) %>'
                                                         alt="Ảnh" class="responsive-image" />
                                                 </div>
                                             </ItemTemplate>
                                         </asp:TemplateField>

                                         <asp:BoundField DataField="Name" HeaderText="Tên danh mục" runat="server">
                                         ...
                                         <asp:TemplateField HeaderText="Thao tác">
                                             ...
                                             <ItemStyle Width="15%" />
                                             <ItemTemplate>
                                                 <asp:LinkButton ID="btnEdit" runat="server" CommandName="EditCategory"
                                                     CommandArgument='<%# Eval("Category_id") %>' CssClass="btn btn-primary btn-sm mr-2">
                             <i class="fas fa-edit"></i> Sửa
                                                 </asp:LinkButton>
                                                 <asp:LinkButton ID="btnDelete" runat="server" CommandName="DeleteCategory"
                                                     CommandArgument='<%# Eval("Category_id") %>' CssClass="btn btn-danger btn-sm"
                             ...
                             <div class="mt-3">
                                 <asp:Button ID="btn1" Text="Thêm danh mục" runat="server" PostBackUrl="~/Admin/AddCategory.aspx" CssClass="btn btn-primary" />
                             </div>
                         </div>
                     </div>
                 </div>
